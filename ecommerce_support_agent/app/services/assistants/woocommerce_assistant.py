# ecommerce_support_agent/app/services/assistants/woocommerce_assistant.py
...
from ecommerce_support_agent.app.services.assistants.assistant_base import Assistant, llm, CompleteOrEscalate
...
woocommerce_assistant_prompt = ChatPromptTemplate.from_messages(
    [
        (
            ...
            "If the user only says '鏌ユ壘璁㈠崟' or similar without providing verification, politely ask them to provide their email address or full name. "
