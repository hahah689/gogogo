...
from ecommerce_support_agent.app.services.tools import (
    search_hotels,
    book_hotel,
    update_hotel,
    cancel_hotel,
)
from ecommerce_support_agent.app.services.assistants.assistant_base import Assistant, CompleteOrEscalate, llm
...
hotel_booking_prompt = ChatPromptTemplate.from_messages(
    [
        (
            ...
            " - 'cancel it' (when referring to an existing booking) 鈫?call cancel_hotel with the hotel_id\n"
            " - 'cancel my hotel booking' 鈫?call cancel_hotel with the hotel_id\n"
            " - 'I want to cancel the reservation' 鈫?call cancel_hotel with the hotel_id\n"
            " - 'please cancel my hotel' 鈫?call cancel_hotel with the hotel_id\n"
