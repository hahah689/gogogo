...
from console_web.app.rag_api import router as rag_router
import uuid
import os
import sys

# Add the ecommerce_support_agent directory to the path
sys.path.append(os.path.join(os.path.dirname(__file__), "..", ".."))

from ecommerce_support_agent.app.services.chat_service import process_user_message
from .core.case_data_manager import (
    get_user_session, 
...
async def get_chat_page(request: Request, session_data: dict = Depends(get_session_data)):
    ...
    response = templates.TemplateResponse("chat.html", {
        ...
        "chat_history": session_data["case_data"].get("chat_history", [])
    })
